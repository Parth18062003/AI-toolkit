  ...
  return (
    <>
      <div className="dark:bg-dot-white/[0.2] bg-dot-black/[0.2]">
        <div className="hidden lg:flex absolute pointer-events-none inset-0 items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_50%,black)]"></div>
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-y-8 lg:gap-x-8 max-w-7xl mx-6 sm:mx-auto py-8">
          <Card className="w-full md:w-1/2 bg-white dark:bg-neutral-950 p-6 border-[1px] border-neutral-300 dark:border-neutral-600 rounded-xl">
            <CardHeader>
              {" "}
              <p className="text-2xl font-bold mb-2 text-neutral-600 dark:text-neutral-300">Free</p>
          ...
          <Card className="w-full md:w-1/2 bg-white dark:bg-neutral-950 p-6 border-[1px] border-neutral-300 dark:border-neutral-600 rounded-xl">
            <CardHeader>
              <p className="text-2xl font-bold mb-2 text-neutral-600 dark:text-neutral-300">Professional</p>
              <p className="text-lg mb-6 text-neutral-600 dark:text-neutral-300">
                Everything to start
              </p>
              <CardTitle>
          ...
          <Card className="w-full md:w-1/2 bg-white dark:bg-neutral-950 p-6 border-[1px] border-neutral-300 dark:border-neutral-600 rounded-xl">
            <CardHeader>
              {" "}
              <p className="text-2xl font-bold mb-2 text-neutral-600 dark:text-neutral-300">Enterprise</p>
              <p className="text-lg mb-6 text-neutral-600 dark:text-neutral-300">
                Everything to start
              </p>
              <CardTitle>
